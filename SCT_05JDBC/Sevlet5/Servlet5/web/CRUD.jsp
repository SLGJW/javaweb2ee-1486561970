...
<body>
<h1>学生列表</h1>
<a href="/stu72/create.html">增添学生</a>&nbsp;&nbsp;
<a href="/stu72/retrieve.html">查找学生</a><br>
<%
...
<table width="400px" cellspacing="0px" border="1px">
    ...
    <tr>
        ...
        <%}%>
        <td>
            <form action="/stu72/DeleteServlet" method="get" onsubmit="return deletes(this.id)">
                <input type="hidden" id="d" value="<%=obj[0]%>" name="sid">
                <input type="submit" value="删除">
            </form>
        </td>
        <td>
            <form action="/stu72/update.jsp" method="get" onsubmit="return updates(this.id)">
...
<h3>点击此处<a href="/stu72/logoutServlet">【注销管理员登录】</a></h3>
</body>
<%} else { %>
<%
